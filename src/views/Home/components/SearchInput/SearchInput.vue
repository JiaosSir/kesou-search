<template>
    <div class="search">
        ...
        <section class="search-input theme-searchInput" ref="searchInput">
            ...
            <div class="search-input-i" @click.stop="">
                <!-- 当前网址的气泡提示 -->
                <el-tooltip class="box-item" effect="dark" :show-after="100" :content="thisUrlName"
                    placement="top-start">
    ...
    <teleport to='#app'>
        <jo-mask v-if="wallpaper.length > 0" :state="showMask" index="0" bgColor="rgba(90, 90, 90, .3)"
            blur="2rem"></jo-mask>
    </teleport>
</template>
<script setup>
